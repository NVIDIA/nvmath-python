...
# Run the generic samples in its own process to work around the Numba bug with
# DEBUG logging.
samples_path = os.path.join(os.path.dirname(__file__), "..", "..", "..", "examples", "sparse", "generic")
