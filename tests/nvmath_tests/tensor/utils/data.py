...
class ContractionTestCase:
    ...
    def gen_random_output(self, framework: Framework, dtype: DType, mem_backend: MemBackend):
        output_shape = self._get_output_shape()
        return get_random_input_data(framework, output_shape, dtype, mem_backend)
...
contraction_test_cases = binary_contraction_test_cases + ternary_contraction_test_cases
