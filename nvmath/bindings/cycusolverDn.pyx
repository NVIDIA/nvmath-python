...
cdef cusolverStatus_t cusolverDnCreate(cusolverDnHandle_t* handle) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCreate(handle)


cdef cusolverStatus_t cusolverDnDestroy(cusolverDnHandle_t handle) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDestroy(handle)


cdef cusolverStatus_t cusolverDnSetStream(cusolverDnHandle_t handle, cudaStream_t streamId) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSetStream(handle, streamId)


cdef cusolverStatus_t cusolverDnGetStream(cusolverDnHandle_t handle, cudaStream_t* streamId) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnGetStream(handle, streamId)


cdef cusolverStatus_t cusolverDnIRSParamsCreate(cusolverDnIRSParams_t* params_ptr) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsCreate(params_ptr)


cdef cusolverStatus_t cusolverDnIRSParamsDestroy(cusolverDnIRSParams_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsDestroy(params)


cdef cusolverStatus_t cusolverDnIRSParamsSetRefinementSolver(cusolverDnIRSParams_t params, cusolverIRSRefinement_t refinement_solver) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsSetRefinementSolver(params, refinement_solver)


cdef cusolverStatus_t cusolverDnIRSParamsSetSolverMainPrecision(cusolverDnIRSParams_t params, cusolverPrecType_t solver_main_precision) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsSetSolverMainPrecision(params, solver_main_precision)


cdef cusolverStatus_t cusolverDnIRSParamsSetSolverLowestPrecision(cusolverDnIRSParams_t params, cusolverPrecType_t solver_lowest_precision) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsSetSolverLowestPrecision(params, solver_lowest_precision)


cdef cusolverStatus_t cusolverDnIRSParamsSetSolverPrecisions(cusolverDnIRSParams_t params, cusolverPrecType_t solver_main_precision, cusolverPrecType_t solver_lowest_precision) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsSetSolverPrecisions(params, solver_main_precision, solver_lowest_precision)


cdef cusolverStatus_t cusolverDnIRSParamsSetTol(cusolverDnIRSParams_t params, double val) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsSetTol(params, val)


cdef cusolverStatus_t cusolverDnIRSParamsSetTolInner(cusolverDnIRSParams_t params, double val) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsSetTolInner(params, val)


cdef cusolverStatus_t cusolverDnIRSParamsSetMaxIters(cusolverDnIRSParams_t params, cusolver_int_t maxiters) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsSetMaxIters(params, maxiters)


cdef cusolverStatus_t cusolverDnIRSParamsSetMaxItersInner(cusolverDnIRSParams_t params, cusolver_int_t maxiters_inner) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsSetMaxItersInner(params, maxiters_inner)


cdef cusolverStatus_t cusolverDnIRSParamsGetMaxIters(cusolverDnIRSParams_t params, cusolver_int_t* maxiters) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsGetMaxIters(params, maxiters)


cdef cusolverStatus_t cusolverDnIRSParamsEnableFallback(cusolverDnIRSParams_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsEnableFallback(params)


cdef cusolverStatus_t cusolverDnIRSParamsDisableFallback(cusolverDnIRSParams_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSParamsDisableFallback(params)


cdef cusolverStatus_t cusolverDnIRSInfosDestroy(cusolverDnIRSInfos_t infos) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSInfosDestroy(infos)


cdef cusolverStatus_t cusolverDnIRSInfosCreate(cusolverDnIRSInfos_t* infos_ptr) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSInfosCreate(infos_ptr)


cdef cusolverStatus_t cusolverDnIRSInfosGetNiters(cusolverDnIRSInfos_t infos, cusolver_int_t* niters) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSInfosGetNiters(infos, niters)


cdef cusolverStatus_t cusolverDnIRSInfosGetOuterNiters(cusolverDnIRSInfos_t infos, cusolver_int_t* outer_niters) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSInfosGetOuterNiters(infos, outer_niters)


cdef cusolverStatus_t cusolverDnIRSInfosRequestResidual(cusolverDnIRSInfos_t infos) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSInfosRequestResidual(infos)


cdef cusolverStatus_t cusolverDnIRSInfosGetResidualHistory(cusolverDnIRSInfos_t infos, void** residual_history) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSInfosGetResidualHistory(infos, residual_history)


cdef cusolverStatus_t cusolverDnIRSInfosGetMaxIters(cusolverDnIRSInfos_t infos, cusolver_int_t* maxiters) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
...
cdef cusolverStatus_t cusolverDnIRSXgesv_bufferSize(cusolverDnHandle_t handle, cusolverDnIRSParams_t params, cusolver_int_t n, cusolver_int_t nrhs, size_t* lwork_bytes) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
...
cdef cusolverStatus_t cusolverDnIRSXgels_bufferSize(cusolverDnHandle_t handle, cusolverDnIRSParams_t params, cusolver_int_t m, cusolver_int_t n, cusolver_int_t nrhs, size_t* lwork_bytes) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnIRSXgels_bufferSize(handle, params, m, n, nrhs, lwork_bytes)


cdef cusolverStatus_t cusolverDnSpotrf_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, float* A, int lda, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSpotrf_bufferSize(handle, uplo, n, A, lda, Lwork)


cdef cusolverStatus_t cusolverDnDpotrf_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDpotrf_bufferSize(handle, uplo, n, A, lda, Lwork)


cdef cusolverStatus_t cusolverDnCpotrf_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCpotrf_bufferSize(handle, uplo, n, A, lda, Lwork)


cdef cusolverStatus_t cusolverDnZpotrf_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZpotrf_bufferSize(handle, uplo, n, A, lda, Lwork)


cdef cusolverStatus_t cusolverDnSpotrf(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, float* A, int lda, float* Workspace, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSpotrf(handle, uplo, n, A, lda, Workspace, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnDpotrf(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, double* Workspace, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDpotrf(handle, uplo, n, A, lda, Workspace, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnCpotrf(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, cuComplex* Workspace, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCpotrf(handle, uplo, n, A, lda, Workspace, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnZpotrf(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, cuDoubleComplex* Workspace, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZpotrf(handle, uplo, n, A, lda, Workspace, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnSpotrs(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, int nrhs, const float* A, int lda, float* B, int ldb, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSpotrs(handle, uplo, n, nrhs, A, lda, B, ldb, devInfo)


cdef cusolverStatus_t cusolverDnDpotrs(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, int nrhs, const double* A, int lda, double* B, int ldb, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDpotrs(handle, uplo, n, nrhs, A, lda, B, ldb, devInfo)


cdef cusolverStatus_t cusolverDnCpotrs(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, int nrhs, const cuComplex* A, int lda, cuComplex* B, int ldb, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCpotrs(handle, uplo, n, nrhs, A, lda, B, ldb, devInfo)


cdef cusolverStatus_t cusolverDnZpotrs(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, int nrhs, const cuDoubleComplex* A, int lda, cuDoubleComplex* B, int ldb, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZpotrs(handle, uplo, n, nrhs, A, lda, B, ldb, devInfo)


cdef cusolverStatus_t cusolverDnSpotrfBatched(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, float* Aarray[], int lda, int* infoArray, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSpotrfBatched(handle, uplo, n, Aarray, lda, infoArray, batchSize)


cdef cusolverStatus_t cusolverDnDpotrfBatched(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* Aarray[], int lda, int* infoArray, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDpotrfBatched(handle, uplo, n, Aarray, lda, infoArray, batchSize)


cdef cusolverStatus_t cusolverDnCpotrfBatched(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* Aarray[], int lda, int* infoArray, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCpotrfBatched(handle, uplo, n, Aarray, lda, infoArray, batchSize)


cdef cusolverStatus_t cusolverDnZpotrfBatched(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* Aarray[], int lda, int* infoArray, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZpotrfBatched(handle, uplo, n, Aarray, lda, infoArray, batchSize)


cdef cusolverStatus_t cusolverDnSpotrsBatched(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, int nrhs, float* A[], int lda, float* B[], int ldb, int* d_info, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSpotrsBatched(handle, uplo, n, nrhs, A, lda, B, ldb, d_info, batchSize)


cdef cusolverStatus_t cusolverDnDpotrsBatched(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, int nrhs, double* A[], int lda, double* B[], int ldb, int* d_info, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDpotrsBatched(handle, uplo, n, nrhs, A, lda, B, ldb, d_info, batchSize)


cdef cusolverStatus_t cusolverDnCpotrsBatched(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, int nrhs, cuComplex* A[], int lda, cuComplex* B[], int ldb, int* d_info, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCpotrsBatched(handle, uplo, n, nrhs, A, lda, B, ldb, d_info, batchSize)


cdef cusolverStatus_t cusolverDnZpotrsBatched(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, int nrhs, cuDoubleComplex* A[], int lda, cuDoubleComplex* B[], int ldb, int* d_info, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZpotrsBatched(handle, uplo, n, nrhs, A, lda, B, ldb, d_info, batchSize)


cdef cusolverStatus_t cusolverDnSpotri_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, float* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSpotri_bufferSize(handle, uplo, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnDpotri_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDpotri_bufferSize(handle, uplo, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnCpotri_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCpotri_bufferSize(handle, uplo, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnZpotri_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZpotri_bufferSize(handle, uplo, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnSpotri(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, float* A, int lda, float* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSpotri(handle, uplo, n, A, lda, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnDpotri(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, double* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDpotri(handle, uplo, n, A, lda, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnCpotri(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, cuComplex* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCpotri(handle, uplo, n, A, lda, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnZpotri(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, cuDoubleComplex* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
...
cdef cusolverStatus_t cusolverDnDlauum_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDlauum_bufferSize(handle, uplo, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnClauum_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnClauum_bufferSize(handle, uplo, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnZlauum_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZlauum_bufferSize(handle, uplo, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnSlauum(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, float* A, int lda, float* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSlauum(handle, uplo, n, A, lda, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnDlauum(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, double* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDlauum(handle, uplo, n, A, lda, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnClauum(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, cuComplex* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnClauum(handle, uplo, n, A, lda, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnZlauum(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, cuDoubleComplex* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZlauum(handle, uplo, n, A, lda, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnSgetrf_bufferSize(cusolverDnHandle_t handle, int m, int n, float* A, int lda, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgetrf_bufferSize(handle, m, n, A, lda, Lwork)


cdef cusolverStatus_t cusolverDnDgetrf_bufferSize(cusolverDnHandle_t handle, int m, int n, double* A, int lda, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgetrf_bufferSize(handle, m, n, A, lda, Lwork)


cdef cusolverStatus_t cusolverDnCgetrf_bufferSize(cusolverDnHandle_t handle, int m, int n, cuComplex* A, int lda, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgetrf_bufferSize(handle, m, n, A, lda, Lwork)


cdef cusolverStatus_t cusolverDnZgetrf_bufferSize(cusolverDnHandle_t handle, int m, int n, cuDoubleComplex* A, int lda, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgetrf_bufferSize(handle, m, n, A, lda, Lwork)


cdef cusolverStatus_t cusolverDnSgetrf(cusolverDnHandle_t handle, int m, int n, float* A, int lda, float* Workspace, int* devIpiv, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgetrf(handle, m, n, A, lda, Workspace, devIpiv, devInfo)


cdef cusolverStatus_t cusolverDnDgetrf(cusolverDnHandle_t handle, int m, int n, double* A, int lda, double* Workspace, int* devIpiv, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgetrf(handle, m, n, A, lda, Workspace, devIpiv, devInfo)


cdef cusolverStatus_t cusolverDnCgetrf(cusolverDnHandle_t handle, int m, int n, cuComplex* A, int lda, cuComplex* Workspace, int* devIpiv, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgetrf(handle, m, n, A, lda, Workspace, devIpiv, devInfo)


cdef cusolverStatus_t cusolverDnZgetrf(cusolverDnHandle_t handle, int m, int n, cuDoubleComplex* A, int lda, cuDoubleComplex* Workspace, int* devIpiv, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgetrf(handle, m, n, A, lda, Workspace, devIpiv, devInfo)


cdef cusolverStatus_t cusolverDnSlaswp(cusolverDnHandle_t handle, int n, float* A, int lda, int k1, int k2, const int* devIpiv, int incx) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSlaswp(handle, n, A, lda, k1, k2, devIpiv, incx)


cdef cusolverStatus_t cusolverDnDlaswp(cusolverDnHandle_t handle, int n, double* A, int lda, int k1, int k2, const int* devIpiv, int incx) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDlaswp(handle, n, A, lda, k1, k2, devIpiv, incx)


cdef cusolverStatus_t cusolverDnClaswp(cusolverDnHandle_t handle, int n, cuComplex* A, int lda, int k1, int k2, const int* devIpiv, int incx) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnClaswp(handle, n, A, lda, k1, k2, devIpiv, incx)


cdef cusolverStatus_t cusolverDnZlaswp(cusolverDnHandle_t handle, int n, cuDoubleComplex* A, int lda, int k1, int k2, const int* devIpiv, int incx) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZlaswp(handle, n, A, lda, k1, k2, devIpiv, incx)


cdef cusolverStatus_t cusolverDnSgetrs(cusolverDnHandle_t handle, cublasOperation_t trans, int n, int nrhs, const float* A, int lda, const int* devIpiv, float* B, int ldb, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgetrs(handle, trans, n, nrhs, A, lda, devIpiv, B, ldb, devInfo)


cdef cusolverStatus_t cusolverDnDgetrs(cusolverDnHandle_t handle, cublasOperation_t trans, int n, int nrhs, const double* A, int lda, const int* devIpiv, double* B, int ldb, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgetrs(handle, trans, n, nrhs, A, lda, devIpiv, B, ldb, devInfo)


cdef cusolverStatus_t cusolverDnCgetrs(cusolverDnHandle_t handle, cublasOperation_t trans, int n, int nrhs, const cuComplex* A, int lda, const int* devIpiv, cuComplex* B, int ldb, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgetrs(handle, trans, n, nrhs, A, lda, devIpiv, B, ldb, devInfo)


cdef cusolverStatus_t cusolverDnZgetrs(cusolverDnHandle_t handle, cublasOperation_t trans, int n, int nrhs, const cuDoubleComplex* A, int lda, const int* devIpiv, cuDoubleComplex* B, int ldb, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgetrs(handle, trans, n, nrhs, A, lda, devIpiv, B, ldb, devInfo)


cdef cusolverStatus_t cusolverDnSgeqrf_bufferSize(cusolverDnHandle_t handle, int m, int n, float* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgeqrf_bufferSize(handle, m, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnDgeqrf_bufferSize(cusolverDnHandle_t handle, int m, int n, double* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgeqrf_bufferSize(handle, m, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnCgeqrf_bufferSize(cusolverDnHandle_t handle, int m, int n, cuComplex* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgeqrf_bufferSize(handle, m, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnZgeqrf_bufferSize(cusolverDnHandle_t handle, int m, int n, cuDoubleComplex* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgeqrf_bufferSize(handle, m, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnSgeqrf(cusolverDnHandle_t handle, int m, int n, float* A, int lda, float* TAU, float* Workspace, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgeqrf(handle, m, n, A, lda, TAU, Workspace, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnDgeqrf(cusolverDnHandle_t handle, int m, int n, double* A, int lda, double* TAU, double* Workspace, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgeqrf(handle, m, n, A, lda, TAU, Workspace, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnCgeqrf(cusolverDnHandle_t handle, int m, int n, cuComplex* A, int lda, cuComplex* TAU, cuComplex* Workspace, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgeqrf(handle, m, n, A, lda, TAU, Workspace, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnZgeqrf(cusolverDnHandle_t handle, int m, int n, cuDoubleComplex* A, int lda, cuDoubleComplex* TAU, cuDoubleComplex* Workspace, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgeqrf(handle, m, n, A, lda, TAU, Workspace, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnSorgqr_bufferSize(cusolverDnHandle_t handle, int m, int n, int k, const float* A, int lda, const float* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSorgqr_bufferSize(handle, m, n, k, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnDorgqr_bufferSize(cusolverDnHandle_t handle, int m, int n, int k, const double* A, int lda, const double* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDorgqr_bufferSize(handle, m, n, k, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnCungqr_bufferSize(cusolverDnHandle_t handle, int m, int n, int k, const cuComplex* A, int lda, const cuComplex* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCungqr_bufferSize(handle, m, n, k, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnZungqr_bufferSize(cusolverDnHandle_t handle, int m, int n, int k, const cuDoubleComplex* A, int lda, const cuDoubleComplex* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZungqr_bufferSize(handle, m, n, k, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnSorgqr(cusolverDnHandle_t handle, int m, int n, int k, float* A, int lda, const float* tau, float* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSorgqr(handle, m, n, k, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnDorgqr(cusolverDnHandle_t handle, int m, int n, int k, double* A, int lda, const double* tau, double* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDorgqr(handle, m, n, k, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnCungqr(cusolverDnHandle_t handle, int m, int n, int k, cuComplex* A, int lda, const cuComplex* tau, cuComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCungqr(handle, m, n, k, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnZungqr(cusolverDnHandle_t handle, int m, int n, int k, cuDoubleComplex* A, int lda, const cuDoubleComplex* tau, cuDoubleComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZungqr(handle, m, n, k, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnSormqr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, cublasOperation_t trans, int m, int n, int k, const float* A, int lda, const float* tau, const float* C, int ldc, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSormqr_bufferSize(handle, side, trans, m, n, k, A, lda, tau, C, ldc, lwork)


cdef cusolverStatus_t cusolverDnDormqr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, cublasOperation_t trans, int m, int n, int k, const double* A, int lda, const double* tau, const double* C, int ldc, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDormqr_bufferSize(handle, side, trans, m, n, k, A, lda, tau, C, ldc, lwork)


cdef cusolverStatus_t cusolverDnCunmqr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, cublasOperation_t trans, int m, int n, int k, const cuComplex* A, int lda, const cuComplex* tau, const cuComplex* C, int ldc, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCunmqr_bufferSize(handle, side, trans, m, n, k, A, lda, tau, C, ldc, lwork)


cdef cusolverStatus_t cusolverDnZunmqr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, cublasOperation_t trans, int m, int n, int k, const cuDoubleComplex* A, int lda, const cuDoubleComplex* tau, const cuDoubleComplex* C, int ldc, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZunmqr_bufferSize(handle, side, trans, m, n, k, A, lda, tau, C, ldc, lwork)


cdef cusolverStatus_t cusolverDnSormqr(cusolverDnHandle_t handle, cublasSideMode_t side, cublasOperation_t trans, int m, int n, int k, const float* A, int lda, const float* tau, float* C, int ldc, float* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSormqr(handle, side, trans, m, n, k, A, lda, tau, C, ldc, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnDormqr(cusolverDnHandle_t handle, cublasSideMode_t side, cublasOperation_t trans, int m, int n, int k, const double* A, int lda, const double* tau, double* C, int ldc, double* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDormqr(handle, side, trans, m, n, k, A, lda, tau, C, ldc, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnCunmqr(cusolverDnHandle_t handle, cublasSideMode_t side, cublasOperation_t trans, int m, int n, int k, const cuComplex* A, int lda, const cuComplex* tau, cuComplex* C, int ldc, cuComplex* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCunmqr(handle, side, trans, m, n, k, A, lda, tau, C, ldc, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnZunmqr(cusolverDnHandle_t handle, cublasSideMode_t side, cublasOperation_t trans, int m, int n, int k, const cuDoubleComplex* A, int lda, const cuDoubleComplex* tau, cuDoubleComplex* C, int ldc, cuDoubleComplex* work, int lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZunmqr(handle, side, trans, m, n, k, A, lda, tau, C, ldc, work, lwork, devInfo)


cdef cusolverStatus_t cusolverDnSsytrf_bufferSize(cusolverDnHandle_t handle, int n, float* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsytrf_bufferSize(handle, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnDsytrf_bufferSize(cusolverDnHandle_t handle, int n, double* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsytrf_bufferSize(handle, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnCsytrf_bufferSize(cusolverDnHandle_t handle, int n, cuComplex* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCsytrf_bufferSize(handle, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnZsytrf_bufferSize(cusolverDnHandle_t handle, int n, cuDoubleComplex* A, int lda, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZsytrf_bufferSize(handle, n, A, lda, lwork)


cdef cusolverStatus_t cusolverDnSsytrf(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, float* A, int lda, int* ipiv, float* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsytrf(handle, uplo, n, A, lda, ipiv, work, lwork, info)


cdef cusolverStatus_t cusolverDnDsytrf(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, int* ipiv, double* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsytrf(handle, uplo, n, A, lda, ipiv, work, lwork, info)


cdef cusolverStatus_t cusolverDnCsytrf(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, int* ipiv, cuComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
...
cdef cusolverStatus_t cusolverDnDsytri_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, const int* ipiv, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsytri_bufferSize(handle, uplo, n, A, lda, ipiv, lwork)


cdef cusolverStatus_t cusolverDnCsytri_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, const int* ipiv, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCsytri_bufferSize(handle, uplo, n, A, lda, ipiv, lwork)


cdef cusolverStatus_t cusolverDnZsytri_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, const int* ipiv, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZsytri_bufferSize(handle, uplo, n, A, lda, ipiv, lwork)


cdef cusolverStatus_t cusolverDnSsytri(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, float* A, int lda, const int* ipiv, float* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsytri(handle, uplo, n, A, lda, ipiv, work, lwork, info)


cdef cusolverStatus_t cusolverDnDsytri(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, const int* ipiv, double* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsytri(handle, uplo, n, A, lda, ipiv, work, lwork, info)


cdef cusolverStatus_t cusolverDnCsytri(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, const int* ipiv, cuComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCsytri(handle, uplo, n, A, lda, ipiv, work, lwork, info)


cdef cusolverStatus_t cusolverDnZsytri(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, const int* ipiv, cuDoubleComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZsytri(handle, uplo, n, A, lda, ipiv, work, lwork, info)


cdef cusolverStatus_t cusolverDnSgebrd_bufferSize(cusolverDnHandle_t handle, int m, int n, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgebrd_bufferSize(handle, m, n, Lwork)


cdef cusolverStatus_t cusolverDnDgebrd_bufferSize(cusolverDnHandle_t handle, int m, int n, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgebrd_bufferSize(handle, m, n, Lwork)


cdef cusolverStatus_t cusolverDnCgebrd_bufferSize(cusolverDnHandle_t handle, int m, int n, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgebrd_bufferSize(handle, m, n, Lwork)


cdef cusolverStatus_t cusolverDnZgebrd_bufferSize(cusolverDnHandle_t handle, int m, int n, int* Lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgebrd_bufferSize(handle, m, n, Lwork)


cdef cusolverStatus_t cusolverDnSgebrd(cusolverDnHandle_t handle, int m, int n, float* A, int lda, float* D, float* E, float* TAUQ, float* TAUP, float* Work, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgebrd(handle, m, n, A, lda, D, E, TAUQ, TAUP, Work, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnDgebrd(cusolverDnHandle_t handle, int m, int n, double* A, int lda, double* D, double* E, double* TAUQ, double* TAUP, double* Work, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgebrd(handle, m, n, A, lda, D, E, TAUQ, TAUP, Work, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnCgebrd(cusolverDnHandle_t handle, int m, int n, cuComplex* A, int lda, float* D, float* E, cuComplex* TAUQ, cuComplex* TAUP, cuComplex* Work, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgebrd(handle, m, n, A, lda, D, E, TAUQ, TAUP, Work, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnZgebrd(cusolverDnHandle_t handle, int m, int n, cuDoubleComplex* A, int lda, double* D, double* E, cuDoubleComplex* TAUQ, cuDoubleComplex* TAUP, cuDoubleComplex* Work, int Lwork, int* devInfo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgebrd(handle, m, n, A, lda, D, E, TAUQ, TAUP, Work, Lwork, devInfo)


cdef cusolverStatus_t cusolverDnSorgbr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, int m, int n, int k, const float* A, int lda, const float* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSorgbr_bufferSize(handle, side, m, n, k, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnDorgbr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, int m, int n, int k, const double* A, int lda, const double* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDorgbr_bufferSize(handle, side, m, n, k, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnCungbr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, int m, int n, int k, const cuComplex* A, int lda, const cuComplex* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCungbr_bufferSize(handle, side, m, n, k, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnZungbr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, int m, int n, int k, const cuDoubleComplex* A, int lda, const cuDoubleComplex* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZungbr_bufferSize(handle, side, m, n, k, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnSorgbr(cusolverDnHandle_t handle, cublasSideMode_t side, int m, int n, int k, float* A, int lda, const float* tau, float* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSorgbr(handle, side, m, n, k, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnDorgbr(cusolverDnHandle_t handle, cublasSideMode_t side, int m, int n, int k, double* A, int lda, const double* tau, double* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDorgbr(handle, side, m, n, k, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnCungbr(cusolverDnHandle_t handle, cublasSideMode_t side, int m, int n, int k, cuComplex* A, int lda, const cuComplex* tau, cuComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCungbr(handle, side, m, n, k, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnZungbr(cusolverDnHandle_t handle, cublasSideMode_t side, int m, int n, int k, cuDoubleComplex* A, int lda, const cuDoubleComplex* tau, cuDoubleComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZungbr(handle, side, m, n, k, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnSsytrd_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, const float* A, int lda, const float* d, const float* e, const float* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsytrd_bufferSize(handle, uplo, n, A, lda, d, e, tau, lwork)


cdef cusolverStatus_t cusolverDnDsytrd_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, const double* A, int lda, const double* d, const double* e, const double* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsytrd_bufferSize(handle, uplo, n, A, lda, d, e, tau, lwork)


cdef cusolverStatus_t cusolverDnChetrd_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, const cuComplex* A, int lda, const float* d, const float* e, const cuComplex* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnChetrd_bufferSize(handle, uplo, n, A, lda, d, e, tau, lwork)


cdef cusolverStatus_t cusolverDnZhetrd_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, const cuDoubleComplex* A, int lda, const double* d, const double* e, const cuDoubleComplex* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZhetrd_bufferSize(handle, uplo, n, A, lda, d, e, tau, lwork)


cdef cusolverStatus_t cusolverDnSsytrd(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, float* A, int lda, float* d, float* e, float* tau, float* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsytrd(handle, uplo, n, A, lda, d, e, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnDsytrd(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, double* d, double* e, double* tau, double* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsytrd(handle, uplo, n, A, lda, d, e, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnChetrd(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, float* d, float* e, cuComplex* tau, cuComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnChetrd(handle, uplo, n, A, lda, d, e, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnZhetrd(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, double* d, double* e, cuDoubleComplex* tau, cuDoubleComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZhetrd(handle, uplo, n, A, lda, d, e, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnSorgtr_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, const float* A, int lda, const float* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSorgtr_bufferSize(handle, uplo, n, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnDorgtr_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, const double* A, int lda, const double* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDorgtr_bufferSize(handle, uplo, n, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnCungtr_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, const cuComplex* A, int lda, const cuComplex* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCungtr_bufferSize(handle, uplo, n, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnZungtr_bufferSize(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, const cuDoubleComplex* A, int lda, const cuDoubleComplex* tau, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZungtr_bufferSize(handle, uplo, n, A, lda, tau, lwork)


cdef cusolverStatus_t cusolverDnSorgtr(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, float* A, int lda, const float* tau, float* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSorgtr(handle, uplo, n, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnDorgtr(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, double* A, int lda, const double* tau, double* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDorgtr(handle, uplo, n, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnCungtr(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuComplex* A, int lda, const cuComplex* tau, cuComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCungtr(handle, uplo, n, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnZungtr(cusolverDnHandle_t handle, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, const cuDoubleComplex* tau, cuDoubleComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZungtr(handle, uplo, n, A, lda, tau, work, lwork, info)


cdef cusolverStatus_t cusolverDnSormtr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, cublasFillMode_t uplo, cublasOperation_t trans, int m, int n, const float* A, int lda, const float* tau, const float* C, int ldc, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSormtr_bufferSize(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, lwork)


cdef cusolverStatus_t cusolverDnDormtr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, cublasFillMode_t uplo, cublasOperation_t trans, int m, int n, const double* A, int lda, const double* tau, const double* C, int ldc, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDormtr_bufferSize(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, lwork)


cdef cusolverStatus_t cusolverDnCunmtr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, cublasFillMode_t uplo, cublasOperation_t trans, int m, int n, const cuComplex* A, int lda, const cuComplex* tau, const cuComplex* C, int ldc, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCunmtr_bufferSize(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, lwork)


cdef cusolverStatus_t cusolverDnZunmtr_bufferSize(cusolverDnHandle_t handle, cublasSideMode_t side, cublasFillMode_t uplo, cublasOperation_t trans, int m, int n, const cuDoubleComplex* A, int lda, const cuDoubleComplex* tau, const cuDoubleComplex* C, int ldc, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZunmtr_bufferSize(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, lwork)


cdef cusolverStatus_t cusolverDnSormtr(cusolverDnHandle_t handle, cublasSideMode_t side, cublasFillMode_t uplo, cublasOperation_t trans, int m, int n, float* A, int lda, float* tau, float* C, int ldc, float* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSormtr(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, work, lwork, info)


cdef cusolverStatus_t cusolverDnDormtr(cusolverDnHandle_t handle, cublasSideMode_t side, cublasFillMode_t uplo, cublasOperation_t trans, int m, int n, double* A, int lda, double* tau, double* C, int ldc, double* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDormtr(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, work, lwork, info)


cdef cusolverStatus_t cusolverDnCunmtr(cusolverDnHandle_t handle, cublasSideMode_t side, cublasFillMode_t uplo, cublasOperation_t trans, int m, int n, cuComplex* A, int lda, cuComplex* tau, cuComplex* C, int ldc, cuComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCunmtr(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, work, lwork, info)


cdef cusolverStatus_t cusolverDnZunmtr(cusolverDnHandle_t handle, cublasSideMode_t side, cublasFillMode_t uplo, cublasOperation_t trans, int m, int n, cuDoubleComplex* A, int lda, cuDoubleComplex* tau, cuDoubleComplex* C, int ldc, cuDoubleComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZunmtr(handle, side, uplo, trans, m, n, A, lda, tau, C, ldc, work, lwork, info)


cdef cusolverStatus_t cusolverDnSgesvd_bufferSize(cusolverDnHandle_t handle, int m, int n, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgesvd_bufferSize(handle, m, n, lwork)


cdef cusolverStatus_t cusolverDnDgesvd_bufferSize(cusolverDnHandle_t handle, int m, int n, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgesvd_bufferSize(handle, m, n, lwork)


cdef cusolverStatus_t cusolverDnCgesvd_bufferSize(cusolverDnHandle_t handle, int m, int n, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgesvd_bufferSize(handle, m, n, lwork)


cdef cusolverStatus_t cusolverDnZgesvd_bufferSize(cusolverDnHandle_t handle, int m, int n, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgesvd_bufferSize(handle, m, n, lwork)


cdef cusolverStatus_t cusolverDnSgesvd(cusolverDnHandle_t handle, signed char jobu, signed char jobvt, int m, int n, float* A, int lda, float* S, float* U, int ldu, float* VT, int ldvt, float* work, int lwork, float* rwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgesvd(handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt, work, lwork, rwork, info)


cdef cusolverStatus_t cusolverDnDgesvd(cusolverDnHandle_t handle, signed char jobu, signed char jobvt, int m, int n, double* A, int lda, double* S, double* U, int ldu, double* VT, int ldvt, double* work, int lwork, double* rwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgesvd(handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt, work, lwork, rwork, info)


cdef cusolverStatus_t cusolverDnCgesvd(cusolverDnHandle_t handle, signed char jobu, signed char jobvt, int m, int n, cuComplex* A, int lda, float* S, cuComplex* U, int ldu, cuComplex* VT, int ldvt, cuComplex* work, int lwork, float* rwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgesvd(handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt, work, lwork, rwork, info)


cdef cusolverStatus_t cusolverDnZgesvd(cusolverDnHandle_t handle, signed char jobu, signed char jobvt, int m, int n, cuDoubleComplex* A, int lda, double* S, cuDoubleComplex* U, int ldu, cuDoubleComplex* VT, int ldvt, cuDoubleComplex* work, int lwork, double* rwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgesvd(handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt, work, lwork, rwork, info)


cdef cusolverStatus_t cusolverDnSsyevd_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const float* A, int lda, const float* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsyevd_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork)


cdef cusolverStatus_t cusolverDnDsyevd_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const double* A, int lda, const double* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsyevd_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork)


cdef cusolverStatus_t cusolverDnCheevd_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const cuComplex* A, int lda, const float* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCheevd_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork)


cdef cusolverStatus_t cusolverDnZheevd_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const cuDoubleComplex* A, int lda, const double* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZheevd_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork)


cdef cusolverStatus_t cusolverDnSsyevd(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, float* A, int lda, float* W, float* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsyevd(handle, jobz, uplo, n, A, lda, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnDsyevd(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, double* A, int lda, double* W, double* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsyevd(handle, jobz, uplo, n, A, lda, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnCheevd(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, cuComplex* A, int lda, float* W, cuComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCheevd(handle, jobz, uplo, n, A, lda, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnZheevd(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, double* W, cuDoubleComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZheevd(handle, jobz, uplo, n, A, lda, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnSsyevdx_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range, cublasFillMode_t uplo, int n, const float* A, int lda, float vl, float vu, int il, int iu, int* meig, const float* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsyevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, meig, W, lwork)


cdef cusolverStatus_t cusolverDnDsyevdx_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range, cublasFillMode_t uplo, int n, const double* A, int lda, double vl, double vu, int il, int iu, int* meig, const double* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsyevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, meig, W, lwork)


cdef cusolverStatus_t cusolverDnCheevdx_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range, cublasFillMode_t uplo, int n, const cuComplex* A, int lda, float vl, float vu, int il, int iu, int* meig, const float* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCheevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, meig, W, lwork)


cdef cusolverStatus_t cusolverDnZheevdx_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range, cublasFillMode_t uplo, int n, const cuDoubleComplex* A, int lda, double vl, double vu, int il, int iu, int* meig, const double* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZheevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, meig, W, lwork)


cdef cusolverStatus_t cusolverDnSsyevdx(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range, cublasFillMode_t uplo, int n, float* A, int lda, float vl, float vu, int il, int iu, int* meig, float* W, float* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsyevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, meig, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnDsyevdx(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range, cublasFillMode_t uplo, int n, double* A, int lda, double vl, double vu, int il, int iu, int* meig, double* W, double* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsyevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, meig, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnCheevdx(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range, cublasFillMode_t uplo, int n, cuComplex* A, int lda, float vl, float vu, int il, int iu, int* meig, float* W, cuComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCheevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, meig, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnZheevdx(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cusolverEigRange_t range, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, double vl, double vu, int il, int iu, int* meig, double* W, cuDoubleComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZheevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, meig, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnSsygvdx_bufferSize(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cusolverEigRange_t range, cublasFillMode_t uplo, int n, const float* A, int lda, const float* B, int ldb, float vl, float vu, int il, int iu, int* meig, const float* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
...
cdef cusolverStatus_t cusolverDnSsygvd_bufferSize(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const float* A, int lda, const float* B, int ldb, const float* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsygvd_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork)


cdef cusolverStatus_t cusolverDnDsygvd_bufferSize(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const double* A, int lda, const double* B, int ldb, const double* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsygvd_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork)


cdef cusolverStatus_t cusolverDnChegvd_bufferSize(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const cuComplex* A, int lda, const cuComplex* B, int ldb, const float* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnChegvd_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork)


cdef cusolverStatus_t cusolverDnZhegvd_bufferSize(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const cuDoubleComplex* A, int lda, const cuDoubleComplex* B, int ldb, const double* W, int* lwork) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZhegvd_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork)


cdef cusolverStatus_t cusolverDnSsygvd(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, float* A, int lda, float* B, int ldb, float* W, float* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsygvd(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnDsygvd(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, double* A, int lda, double* B, int ldb, double* W, double* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsygvd(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnChegvd(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, cuComplex* A, int lda, cuComplex* B, int ldb, float* W, cuComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnChegvd(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnZhegvd(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, cuDoubleComplex* B, int ldb, double* W, cuDoubleComplex* work, int lwork, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZhegvd(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork, info)


cdef cusolverStatus_t cusolverDnCreateSyevjInfo(syevjInfo_t* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCreateSyevjInfo(info)


cdef cusolverStatus_t cusolverDnDestroySyevjInfo(syevjInfo_t info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDestroySyevjInfo(info)


cdef cusolverStatus_t cusolverDnXsyevjSetTolerance(syevjInfo_t info, double tolerance) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXsyevjSetTolerance(info, tolerance)


cdef cusolverStatus_t cusolverDnXsyevjSetMaxSweeps(syevjInfo_t info, int max_sweeps) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXsyevjSetMaxSweeps(info, max_sweeps)


cdef cusolverStatus_t cusolverDnXsyevjSetSortEig(syevjInfo_t info, int sort_eig) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXsyevjSetSortEig(info, sort_eig)


cdef cusolverStatus_t cusolverDnXsyevjGetResidual(cusolverDnHandle_t handle, syevjInfo_t info, double* residual) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXsyevjGetResidual(handle, info, residual)


cdef cusolverStatus_t cusolverDnXsyevjGetSweeps(cusolverDnHandle_t handle, syevjInfo_t info, int* executed_sweeps) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXsyevjGetSweeps(handle, info, executed_sweeps)


cdef cusolverStatus_t cusolverDnSsyevjBatched_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const float* A, int lda, const float* W, int* lwork, syevjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsyevjBatched_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork, params, batchSize)


cdef cusolverStatus_t cusolverDnDsyevjBatched_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const double* A, int lda, const double* W, int* lwork, syevjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsyevjBatched_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork, params, batchSize)


cdef cusolverStatus_t cusolverDnCheevjBatched_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const cuComplex* A, int lda, const float* W, int* lwork, syevjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCheevjBatched_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork, params, batchSize)


cdef cusolverStatus_t cusolverDnZheevjBatched_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const cuDoubleComplex* A, int lda, const double* W, int* lwork, syevjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZheevjBatched_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork, params, batchSize)


cdef cusolverStatus_t cusolverDnSsyevjBatched(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, float* A, int lda, float* W, float* work, int lwork, int* info, syevjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsyevjBatched(handle, jobz, uplo, n, A, lda, W, work, lwork, info, params, batchSize)


cdef cusolverStatus_t cusolverDnDsyevjBatched(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, double* A, int lda, double* W, double* work, int lwork, int* info, syevjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsyevjBatched(handle, jobz, uplo, n, A, lda, W, work, lwork, info, params, batchSize)


cdef cusolverStatus_t cusolverDnCheevjBatched(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, cuComplex* A, int lda, float* W, cuComplex* work, int lwork, int* info, syevjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCheevjBatched(handle, jobz, uplo, n, A, lda, W, work, lwork, info, params, batchSize)


cdef cusolverStatus_t cusolverDnZheevjBatched(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, double* W, cuDoubleComplex* work, int lwork, int* info, syevjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZheevjBatched(handle, jobz, uplo, n, A, lda, W, work, lwork, info, params, batchSize)


cdef cusolverStatus_t cusolverDnSsyevj_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const float* A, int lda, const float* W, int* lwork, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsyevj_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork, params)


cdef cusolverStatus_t cusolverDnDsyevj_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const double* A, int lda, const double* W, int* lwork, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsyevj_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork, params)


cdef cusolverStatus_t cusolverDnCheevj_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const cuComplex* A, int lda, const float* W, int* lwork, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCheevj_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork, params)


cdef cusolverStatus_t cusolverDnZheevj_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const cuDoubleComplex* A, int lda, const double* W, int* lwork, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZheevj_bufferSize(handle, jobz, uplo, n, A, lda, W, lwork, params)


cdef cusolverStatus_t cusolverDnSsyevj(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, float* A, int lda, float* W, float* work, int lwork, int* info, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsyevj(handle, jobz, uplo, n, A, lda, W, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnDsyevj(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, double* A, int lda, double* W, double* work, int lwork, int* info, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsyevj(handle, jobz, uplo, n, A, lda, W, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnCheevj(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, cuComplex* A, int lda, float* W, cuComplex* work, int lwork, int* info, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCheevj(handle, jobz, uplo, n, A, lda, W, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnZheevj(cusolverDnHandle_t handle, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, double* W, cuDoubleComplex* work, int lwork, int* info, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZheevj(handle, jobz, uplo, n, A, lda, W, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnSsygvj_bufferSize(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const float* A, int lda, const float* B, int ldb, const float* W, int* lwork, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsygvj_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork, params)


cdef cusolverStatus_t cusolverDnDsygvj_bufferSize(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const double* A, int lda, const double* B, int ldb, const double* W, int* lwork, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsygvj_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork, params)


cdef cusolverStatus_t cusolverDnChegvj_bufferSize(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const cuComplex* A, int lda, const cuComplex* B, int ldb, const float* W, int* lwork, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnChegvj_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork, params)


cdef cusolverStatus_t cusolverDnZhegvj_bufferSize(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, const cuDoubleComplex* A, int lda, const cuDoubleComplex* B, int ldb, const double* W, int* lwork, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZhegvj_bufferSize(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, lwork, params)


cdef cusolverStatus_t cusolverDnSsygvj(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, float* A, int lda, float* B, int ldb, float* W, float* work, int lwork, int* info, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSsygvj(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnDsygvj(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, double* A, int lda, double* B, int ldb, double* W, double* work, int lwork, int* info, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDsygvj(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnChegvj(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, cuComplex* A, int lda, cuComplex* B, int ldb, float* W, cuComplex* work, int lwork, int* info, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnChegvj(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnZhegvj(cusolverDnHandle_t handle, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int n, cuDoubleComplex* A, int lda, cuDoubleComplex* B, int ldb, double* W, cuDoubleComplex* work, int lwork, int* info, syevjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZhegvj(handle, itype, jobz, uplo, n, A, lda, B, ldb, W, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnCreateGesvdjInfo(gesvdjInfo_t* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCreateGesvdjInfo(info)


cdef cusolverStatus_t cusolverDnDestroyGesvdjInfo(gesvdjInfo_t info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDestroyGesvdjInfo(info)


cdef cusolverStatus_t cusolverDnXgesvdjSetTolerance(gesvdjInfo_t info, double tolerance) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXgesvdjSetTolerance(info, tolerance)


cdef cusolverStatus_t cusolverDnXgesvdjSetMaxSweeps(gesvdjInfo_t info, int max_sweeps) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXgesvdjSetMaxSweeps(info, max_sweeps)


cdef cusolverStatus_t cusolverDnXgesvdjSetSortEig(gesvdjInfo_t info, int sort_svd) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXgesvdjSetSortEig(info, sort_svd)


cdef cusolverStatus_t cusolverDnXgesvdjGetResidual(cusolverDnHandle_t handle, gesvdjInfo_t info, double* residual) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXgesvdjGetResidual(handle, info, residual)


cdef cusolverStatus_t cusolverDnXgesvdjGetSweeps(cusolverDnHandle_t handle, gesvdjInfo_t info, int* executed_sweeps) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXgesvdjGetSweeps(handle, info, executed_sweeps)


cdef cusolverStatus_t cusolverDnSgesvdjBatched_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int m, int n, const float* A, int lda, const float* S, const float* U, int ldu, const float* V, int ldv, int* lwork, gesvdjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgesvdjBatched_bufferSize(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, lwork, params, batchSize)


cdef cusolverStatus_t cusolverDnDgesvdjBatched_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int m, int n, const double* A, int lda, const double* S, const double* U, int ldu, const double* V, int ldv, int* lwork, gesvdjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgesvdjBatched_bufferSize(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, lwork, params, batchSize)


cdef cusolverStatus_t cusolverDnCgesvdjBatched_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int m, int n, const cuComplex* A, int lda, const float* S, const cuComplex* U, int ldu, const cuComplex* V, int ldv, int* lwork, gesvdjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgesvdjBatched_bufferSize(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, lwork, params, batchSize)


cdef cusolverStatus_t cusolverDnZgesvdjBatched_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int m, int n, const cuDoubleComplex* A, int lda, const double* S, const cuDoubleComplex* U, int ldu, const cuDoubleComplex* V, int ldv, int* lwork, gesvdjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgesvdjBatched_bufferSize(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, lwork, params, batchSize)


cdef cusolverStatus_t cusolverDnSgesvdjBatched(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int m, int n, float* A, int lda, float* S, float* U, int ldu, float* V, int ldv, float* work, int lwork, int* info, gesvdjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgesvdjBatched(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params, batchSize)


cdef cusolverStatus_t cusolverDnDgesvdjBatched(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int m, int n, double* A, int lda, double* S, double* U, int ldu, double* V, int ldv, double* work, int lwork, int* info, gesvdjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgesvdjBatched(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params, batchSize)


cdef cusolverStatus_t cusolverDnCgesvdjBatched(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int m, int n, cuComplex* A, int lda, float* S, cuComplex* U, int ldu, cuComplex* V, int ldv, cuComplex* work, int lwork, int* info, gesvdjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgesvdjBatched(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params, batchSize)


cdef cusolverStatus_t cusolverDnZgesvdjBatched(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int m, int n, cuDoubleComplex* A, int lda, double* S, cuDoubleComplex* U, int ldu, cuDoubleComplex* V, int ldv, cuDoubleComplex* work, int lwork, int* info, gesvdjInfo_t params, int batchSize) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgesvdjBatched(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params, batchSize)


cdef cusolverStatus_t cusolverDnSgesvdj_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n, const float* A, int lda, const float* S, const float* U, int ldu, const float* V, int ldv, int* lwork, gesvdjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, lwork, params)


cdef cusolverStatus_t cusolverDnDgesvdj_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n, const double* A, int lda, const double* S, const double* U, int ldu, const double* V, int ldv, int* lwork, gesvdjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, lwork, params)


cdef cusolverStatus_t cusolverDnCgesvdj_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n, const cuComplex* A, int lda, const float* S, const cuComplex* U, int ldu, const cuComplex* V, int ldv, int* lwork, gesvdjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, lwork, params)


cdef cusolverStatus_t cusolverDnZgesvdj_bufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n, const cuDoubleComplex* A, int lda, const double* S, const cuDoubleComplex* U, int ldu, const cuDoubleComplex* V, int ldv, int* lwork, gesvdjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnZgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, lwork, params)


cdef cusolverStatus_t cusolverDnSgesvdj(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n, float* A, int lda, float* S, float* U, int ldu, float* V, int ldv, float* work, int lwork, int* info, gesvdjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSgesvdj(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnDgesvdj(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n, double* A, int lda, double* S, double* U, int ldu, double* V, int ldv, double* work, int lwork, int* info, gesvdjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDgesvdj(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnCgesvdj(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n, cuComplex* A, int lda, float* S, cuComplex* U, int ldu, cuComplex* V, int ldv, cuComplex* work, int lwork, int* info, gesvdjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCgesvdj(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params)


cdef cusolverStatus_t cusolverDnZgesvdj(cusolverDnHandle_t handle, cusolverEigMode_t jobz, int econ, int m, int n, cuDoubleComplex* A, int lda, double* S, cuDoubleComplex* U, int ldu, cuDoubleComplex* V, int ldv, cuDoubleComplex* work, int lwork, int* info, gesvdjInfo_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
...
cdef cusolverStatus_t cusolverDnCreateParams(cusolverDnParams_t* params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnCreateParams(params)


cdef cusolverStatus_t cusolverDnDestroyParams(cusolverDnParams_t params) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnDestroyParams(params)


cdef cusolverStatus_t cusolverDnSetAdvOptions(cusolverDnParams_t params, cusolverDnFunction_t function, cusolverAlgMode_t algo) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSetAdvOptions(params, function, algo)


cdef cusolverStatus_t cusolverDnXpotrf_bufferSize(cusolverDnHandle_t handle, cusolverDnParams_t params, cublasFillMode_t uplo, int64_t n, cudaDataType dataTypeA, const void* A, int64_t lda, cudaDataType computeType, size_t* workspaceInBytesOnDevice, size_t* workspaceInBytesOnHost) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
...
cdef cusolverStatus_t cusolverDnXpotrs(cusolverDnHandle_t handle, cusolverDnParams_t params, cublasFillMode_t uplo, int64_t n, int64_t nrhs, cudaDataType dataTypeA, const void* A, int64_t lda, cudaDataType dataTypeB, void* B, int64_t ldb, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
...
cdef cusolverStatus_t cusolverDnLoggerSetFile(FILE* file) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnLoggerSetFile(file)


cdef cusolverStatus_t cusolverDnLoggerOpenFile(const char* logFile) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnLoggerOpenFile(logFile)


cdef cusolverStatus_t cusolverDnLoggerSetLevel(int level) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnLoggerSetLevel(level)


cdef cusolverStatus_t cusolverDnLoggerSetMask(int mask) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnLoggerSetMask(mask)


cdef cusolverStatus_t cusolverDnLoggerForceDisable() except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnLoggerForceDisable()


cdef cusolverStatus_t cusolverDnSetDeterministicMode(cusolverDnHandle_t handle, cusolverDeterministicMode_t mode) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSetDeterministicMode(handle, mode)


cdef cusolverStatus_t cusolverDnGetDeterministicMode(cusolverDnHandle_t handle, cusolverDeterministicMode_t* mode) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
...
cdef cusolverStatus_t cusolverDnSetFixedPointEmulationMantissaControl(cusolverDnHandle_t handle, cudaEmulationMantissaControl_t control) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSetFixedPointEmulationMantissaControl(handle, control)
...
cdef cusolverStatus_t cusolverDnGetFixedPointEmulationMantissaControl(cusolverDnHandle_t handle, cudaEmulationMantissaControl_t* control) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnGetFixedPointEmulationMantissaControl(handle, control)
...
cdef cusolverStatus_t cusolverDnSetFixedPointEmulationMaxMantissaBitCount(cusolverDnHandle_t handle, int mantissaBitCount) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSetFixedPointEmulationMaxMantissaBitCount(handle, mantissaBitCount)
...
cdef cusolverStatus_t cusolverDnGetFixedPointEmulationMaxMantissaBitCount(cusolverDnHandle_t handle, int* mantissaBitCount) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnGetFixedPointEmulationMaxMantissaBitCount(handle, mantissaBitCount)
...
cdef cusolverStatus_t cusolverDnSetFixedPointEmulationMantissaBitOffset(cusolverDnHandle_t handle, int mantissaBitOffset) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSetFixedPointEmulationMantissaBitOffset(handle, mantissaBitOffset)
...
cdef cusolverStatus_t cusolverDnGetFixedPointEmulationMantissaBitOffset(cusolverDnHandle_t handle, int* mantissaBitOffset) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnGetFixedPointEmulationMantissaBitOffset(handle, mantissaBitOffset)
...
cdef cusolverStatus_t cusolverDnSetEmulationSpecialValuesSupport(cusolverDnHandle_t handle, cudaEmulationSpecialValuesSupport_t mask) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnSetEmulationSpecialValuesSupport(handle, mask)
...
cdef cusolverStatus_t cusolverDnGetEmulationSpecialValuesSupport(cusolverDnHandle_t handle, cudaEmulationSpecialValuesSupport_t* mask) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnGetEmulationSpecialValuesSupport(handle, mask)
...
cdef cusolverStatus_t cusolverDnXsygvd_bufferSize(cusolverDnHandle_t handle, cusolverDnParams_t params, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int64_t n, cudaDataType dataTypeA, const void* d_A, int64_t lda, cudaDataType dataTypeB, const void* d_B, int64_t ldb, cudaDataType dataTypeW, const void* d_W, cudaDataType computeType, size_t* workspaceInBytesOnDevice, size_t* workspaceInBytesOnHost) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXsygvd_bufferSize(handle, params, itype, jobz, uplo, n, dataTypeA, d_A, lda, dataTypeB, d_B, ldb, dataTypeW, d_W, computeType, workspaceInBytesOnDevice, workspaceInBytesOnHost)
...
cdef cusolverStatus_t cusolverDnXsygvd(cusolverDnHandle_t handle, cusolverDnParams_t params, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int64_t n, cudaDataType dataTypeA, void* d_A, int64_t lda, cudaDataType dataTypeB, void* d_B, int64_t ldb, cudaDataType dataTypeW, void* d_W, cudaDataType computeType, void* bufferOnDevice, size_t workspaceInBytesOnDevice, void* bufferOnHost, size_t workspaceInBytesOnHost, int* d_info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXsygvd(handle, params, itype, jobz, uplo, n, dataTypeA, d_A, lda, dataTypeB, d_B, ldb, dataTypeW, d_W, computeType, bufferOnDevice, workspaceInBytesOnDevice, bufferOnHost, workspaceInBytesOnHost, d_info)
...
cdef cusolverStatus_t cusolverDnXsygvdx_bufferSize(cusolverDnHandle_t handle, cusolverDnParams_t params, cusolverEigType_t itype, cusolverEigMode_t jobz, cublasFillMode_t uplo, int64_t n, cudaDataType dataTypeA, const void* d_A, int64_t lda, cudaDataType dataTypeB, const void* d_B, int64_t ldb, void* vl, void* vu, int64_t il, int64_t iu, int64_t* meig, cudaDataType dataTypeW, const void* d_W, cudaDataType computeType, size_t* workspaceInBytesOnDevice, size_t* workspaceInBytesOnHost) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXsygvdx_bufferSize(handle, params, itype, jobz, uplo, n, dataTypeA, d_A, lda, dataTypeB, d_B, ldb, vl, vu, il, iu, meig, dataTypeW, d_W, computeType, workspaceInBytesOnDevice, workspaceInBytesOnHost)
...
cdef cusolverStatus_t cusolverDnXsygvdx(cusolverDnHandle_t handle, cusolverDnParams_t params, cusolverEigType_t itype, cusolverEigMode_t jobz, cusolverEigRange_t range, cublasFillMode_t uplo, int64_t n, cudaDataType dataTypeA, void* d_A, int64_t lda, cudaDataType dataTypeB, void* d_B, int64_t ldb, void* vl, void* vu, int64_t il, int64_t iu, int64_t* meig, cudaDataType dataTypeW, void* d_W, cudaDataType computeType, void* bufferOnDevice, size_t workspaceInBytesOnDevice, void* bufferOnHost, size_t workspaceInBytesOnHost, int* d_info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXsygvdx(handle, params, itype, jobz, range, uplo, n, dataTypeA, d_A, lda, dataTypeB, d_B, ldb, vl, vu, il, iu, meig, dataTypeW, d_W, computeType, bufferOnDevice, workspaceInBytesOnDevice, bufferOnHost, workspaceInBytesOnHost, d_info)
...
cdef cusolverStatus_t cusolverDnXstedc_bufferSize(cusolverDnHandle_t handle, cusolverDnParams_t params, cusolverEigComp_t compz, int64_t n, cudaDataType dataTypeDE, const void* D, const void* E, cudaDataType dataTypeZ, const void* Z, int64_t ldz, cudaDataType computeType, size_t* workspaceInBytesOnDevice, size_t* workspaceInBytesOnHost) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXstedc_bufferSize(handle, params, compz, n, dataTypeDE, D, E, dataTypeZ, Z, ldz, computeType, workspaceInBytesOnDevice, workspaceInBytesOnHost)
...
cdef cusolverStatus_t cusolverDnXstedc(cusolverDnHandle_t handle, cusolverDnParams_t params, cusolverEigComp_t compz, int64_t n, cudaDataType dataTypeDE, void* D, void* E, cudaDataType dataTypeZ, void* Z, int64_t ldz, cudaDataType computeType, void* bufferOnDevice, size_t workspaceInBytesOnDevice, void* bufferOnHost, size_t workspaceInBytesOnHost, int* info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXstedc(handle, params, compz, n, dataTypeDE, D, E, dataTypeZ, Z, ldz, computeType, bufferOnDevice, workspaceInBytesOnDevice, bufferOnHost, workspaceInBytesOnHost, info)
...
cdef cusolverStatus_t cusolverDnXpolar_bufferSize(cusolverDnHandle_t handle, cusolverDnParams_t params, cublasFillMode_t uplo, int64_t M, int64_t N, cudaDataType dataTypeA, const void* A, int64_t lda, cudaDataType dataTypeH, const void* H, int64_t ldh, cudaDataType computeType, size_t* workspaceInBytesOnDevice, size_t* workspaceInBytesOnHost) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXpolar_bufferSize(handle, params, uplo, M, N, dataTypeA, A, lda, dataTypeH, H, ldh, computeType, workspaceInBytesOnDevice, workspaceInBytesOnHost)
...
cdef cusolverStatus_t cusolverDnXpolar(cusolverDnHandle_t handle, cusolverDnParams_t params, cublasFillMode_t uplo, int64_t M, int64_t N, cudaDataType dataTypeA, void* A, int64_t lda, cudaDataType dataTypeH, void* H, int64_t ldh, cudaDataType computeType, void* bufferOnDevice, size_t workspaceInBytesOnDevice, void* bufferOnHost, size_t workspaceInBytesOnHost, double* d_res_nrm, double* d_A_nrmF, double* d_rcond, int* d_info) except?_CUSOLVERSTATUS_T_INTERNAL_LOADING_ERROR nogil:
    return _cusolverDn._cusolverDnXpolar(handle, params, uplo, M, N, dataTypeA, A, lda, dataTypeH, H, ldh, computeType, bufferOnDevice, workspaceInBytesOnDevice, bufferOnHost, workspaceInBytesOnHost, d_res_nrm, d_A_nrmF, d_rcond, d_info)
