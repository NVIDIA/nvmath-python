...
cpdef _xt_set_jit_callback(int plan, intptr_t lto_callback_symbol_name, lto_callback_fatbin, size_t lto_callback_fatbin_size, int type, caller_info):
    ...
    with nogil:
        __status__ = cufftXtSetJITCallback(<cufftHandle>plan, <const char*>lto_callback_symbol_name, <const void*>_lto_callback_fatbin_, lto_callback_fatbin_size, <_XtCallbackType>type, <void**>(_caller_info_.data()))
    check_status(__status__)
...
cpdef _xt_set_jit_callback_12_7(int plan, intptr_t lto_callback_symbol_name, lto_callback_fatbin, size_t lto_callback_fatbin_size, int type, caller_info):
    ...
    get_resource_ptrs[void](_caller_info_, caller_info, <void*>NULL)
    with nogil:
        __status__ = __cufftXtSetJITCallback_12_7(<cufftHandle>plan, <const char*>lto_callback_symbol_name, <const void*>_lto_callback_fatbin_, lto_callback_fatbin_size, <_XtCallbackType>type, <void**>(_caller_info_.data()))
    check_status(__status__)
