...
def main():
    ...
    FFT = fft(fft_type='c2c', size=fft_size, precision=np.float32, direction='forward', execution='Block',
              elements_per_thread=elements_per_thread, ffts_per_block=ffts_per_block, compiler='numba')
