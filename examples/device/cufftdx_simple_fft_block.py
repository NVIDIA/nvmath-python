...
#
# Mirrors https://github.com/NVIDIA/CUDALibrarySamples/blob/master/MathDx/cuFFTDx/simple_fft_block.cu
#
...
def main():
    ...
    FFT = fft(fft_type='c2c', size=128, precision=np.float32, direction='forward', elements_per_thread=8, ffts_per_block=2, execution='Block', compiler='numba')
